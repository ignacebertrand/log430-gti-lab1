 ...
 * DeliveryList object that maintains a list of deliveries that the driver has
 * made previously. deliveriesAssignedList is also a DeliveryList object that
 * maintains a list of deliveries assigned to the driver for the current day.
 *
