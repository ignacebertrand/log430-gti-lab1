 ...
 * Modification Log
 * *********************************************************************** v1.5,
 * R. Champagne, 2012-May-31 - Various refactorings for new lab.
 *
    ...
    private Driver parseText(String lineOfText) {
        ...
        while (!done) {
            ...
            switch (tokenCount) {
                ...
                default:
                    /*
                     * This is where the previous deliveries are added to the
                     * driver's previous deliveries made list within the driver
                     * object. This needs to be parsed at ":" to separate ID and
                     * estimated duration.
                     */
